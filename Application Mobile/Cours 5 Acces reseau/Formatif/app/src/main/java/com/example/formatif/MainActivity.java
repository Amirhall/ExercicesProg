...
import com.example.formatif.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        abToggle = new ActionBarDrawerToggle(this,dl, R.string.nav_open, R.string.nav_close){
            @Override
            ...
            public void onDrawerClosed(View drawerView) {
                ...
                getSupportActionBar().setTitle(R.string.nav_close);
